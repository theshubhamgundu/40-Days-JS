...
let txt = 'In 2024, I run 40 Days of Python. Now, in 2025 I super exited to start this challenge'
let regEx = /\d/g // d with escape character means d not a normal d instead acts a digit
// + means one or more digit numbers, 
// if there is g after that it means global, search everywhere.
console.log(txt.match(regEx)) // ["2", "0", "2", "4", "3", "0", "2", "0", "2", "5"]
console.log(txt.match(/\d+/g)) // ["2024", "40", "2025"]
