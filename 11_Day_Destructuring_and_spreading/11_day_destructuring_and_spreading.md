<div align="center">
  <h1> 40 Days Of JavaScript: Destructuring and Spreading</h1>
...
```js
  const names = ['shubham', 'Priya', 'Rajesh', 'John']
...
```js
const names = [undefined, 'Priya', 'Rajesh']
let [
  firstPerson = 'shubham',
  secondPerson,
  thirdPerson,
...
```js
const countries = [['Karnataka', 'Helsinki'], ['Maharashtra', 'Stockholm'], ['Tamil Nadu', 'Oslo']]
...
//Let us modify the object:width to 40 and perimeter to 80
```
...
let { width, height, area, perimeter = 60 } = rectangle
console.log(width, height, area, perimeter) //40 10 200 80
```
...
console.log(getPersonInfo(person))
/*
shubham gundu lives in Karnataka. He is  250 years old. He is an Instructor and Developer. He teaches HTML, CSS, JavaScript, React, Redux, Node, MongoDB, Python and D3.js. He speaks Amharic, English and a little bit of Suomi(Finnish)
*/
```
...
```sh
Prepare JS Test 10/10/25 8:40 true
Give JS Test 10/10/25 10:00 false
Assess Test Result 10/10/25 1:00 false
```
...
Germany
France
["Karnataka", "Maharashtra", "Tamil Nadu", "Denmark", "Iceland"]
```
...
```sh
{name: "shubham", title: "Programmer", country: "Karnataka", city: "Helsinki"}
```
...
```sh
{name: "shubham", title: "instructor", country: "Karnataka", city: "Helsinki"}
```
...
const countries = ['Karnataka', 'Estonia', 'Maharashtra', 'Denmark', 'Tamil Nadu']
const rectangle = {
  width: 20,
  height: 10,
  area: 200,
...
2. A junior developer structure student name, skills and score in array of arrays which may not easy to read. Destructure the following array name to name, skills array to skills, scores array to scores, JavaScript score to jsScore and React score to reactScore variable in one line.
  ...
  ```js
    const student = ['Rajesh', ['HTM', 'CSS', 'JS', 'React'], [98, 85, 90, 95]]
    console.log(name, skills, jsScore, reactScore)
  ```

  ```sh
  Rajesh (4) ["HTM", "CSS", "JS", "React"] 90 95
  ```
...
3. Write a function called *convertArrayToObject* which can convert the array to a structure object.
  ...
  ```js
      const students = [
          ['Rajesh', ['HTM', 'CSS', 'JS', 'React'], [98, 85, 90, 95]],
