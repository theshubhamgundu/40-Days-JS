<div align="center">
  <h1> 40 Days Of JavaScript: Objects</h1>
...
// block scope
  if (true) {
    ...
    let d = 40
    value = !value
    console.log(a, b, c, value) // Python 20 40 true
  }
