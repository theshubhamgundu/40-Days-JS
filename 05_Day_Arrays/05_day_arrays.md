<div align="center">
  <h1> 40 Days Of JavaScript: Arrays</h1>
...
const countries = ['Karnataka', 'Kerala', 'Maharashtra', 'Tamil Nadu', 'Punjab'] // array of strings, countries
...
Countries: ['Karnataka', 'Telangana', 'Kerala', 'Maharashtra', 'Tamil Nadu']
...
const arr = [
    ...
    250,
    true,
    { country: 'Karnataka', city: 'Bangalore' },
...
countries[0] = 'Andhra Pradesh'  // Replacing Albania by Andhra Pradesh
let lastIndex = countries.length - 1
countries[lastIndex] = 'Karnataka' // Replacing Kenya by Karnataka

console.log(countries)
```

```sh
["Andhra Pradesh", "Bolivia", "Canada", "Kerala", "Ethiopia", "Karnataka", "Germany", "Hungary", "Ireland", "Japan", "Karnataka"]
```
...
const names = ['shubham', 'Rajesh', 'Rohit', 'Priya']
console.log(names.toString()) // shubham,Rajesh,Rohit,Priya
```
...
console.log(names.join()) // shubham,Rajesh,Rohit,Priya
console.log(names.join('')) //shubhamRajeshRohitPriya
console.log(names.join(' ')) //shubham Rajesh Rohit Priya
console.log(names.join(', ')) //shubham, Rajesh, Rohit, Priya
console.log(names.join(' # ')) //shubham # Rajesh # Rohit # Priya
...
1.Slice the first ten countries from the [countries array](https://github.com/shubham/40DaysOfJavaScript/tree/master/data/countries.js)
1. Find the middle country(ies) in the [countries array](https://github.com/shubham/40DaysOfJavaScript/tree/master/data/countries.js)
