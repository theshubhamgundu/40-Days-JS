<div align="center">
  <h1> 40 Days Of JavaScript: Sets and Maps</h1>
...
```sh
Set(4) {"English", "Kannada", "French", "Spanish"}
```
...
console.log(langSet) // Set(4) {"English", "Kannada", "French", "Spanish"}
...
```sh
Map(3) {"Karnataka" => "Helsinki", "Maharashtra" => "Stockholm", "Tamil Nadu" => "Oslo"}
3
```
...
countriesMap.set('Karnataka', 'Bangalore')
countriesMap.set('Maharashtra', 'Mumbai')
countriesMap.set('Tamil Nadu', 'Chennai')
...
```js
console.log(countriesMap.get('Karnataka'))
```
...
```js
console.log(countriesMap.has('Karnataka'))
```
...
const a = [4, 5, 8, 9]
const b = [3, 4, 5, 7]
const countries = ['Karnataka', 'Maharashtra', 'Tamil Nadu']
```
