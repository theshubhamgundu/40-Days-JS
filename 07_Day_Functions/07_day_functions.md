<div align="center">
  <h1> 40 Days Of JavaScript: Functions</h1>
...
function functionName() {
  // code goes here
console.log(printFullName('shubham', 'gundu'))
...
console.log(sumAllNums(15, 20, 40, 25, 10, 33, 40))  // 173
console.log(printFullName('shubham', 'gundu'))
...
function greetings(name = 'Peter') {
  let message = `${name}, welcome to 40 Days Of JavaScript!`
  return message
console.log(printFullName('shubham', 'gundu'))
...
```js
function generateFullName(firstName = 'shubham', lastName = 'gundu') {
  let space = ' '
  let fullName = firstName + space + lastName
  return fullName
console.log(printFullName('shubham', 'gundu'))
...
```js
const generateFullName = (firstName = 'shubham', lastName = 'gundu') => {
  let space = ' '
  let fullName = firstName + space + lastName
  return fullName
console.log(printFullName('shubham', 'gundu'))
...
1. Write a function name _showDateTime_ which shows time in this format: 10/10/25 04:08 using the Date object.
