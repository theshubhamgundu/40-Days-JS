<div align="center">
  <h1> 40 Days Of JavaScript: Web Storages</h1>
...
```js
localStorage.setItem('firstName', 'shubham') // since the value is string we do not stringify it
console.log(localStorage)
```

```sh
Storage {firstName: 'shubham', length: 1}
```
...
```sh
 Storage {age: '200', firstName: 'shubham', length: 2}
```
...
```sh
Storage {age: '200', firstName: 'shubham', skills: 'HTML,CSS,JS,React', length: 3}
```
