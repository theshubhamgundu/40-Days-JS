<div align="center">
  <h1> 40 Days Of JavaScript: Regular Expressions</h1>
...
const txt = 'This regular expression example was made in OCTOBER 12,  2025.'
const matches = txt. match(pattern)
...
console.log(matches)  // ["12", "2025"], this is not what we want
```
