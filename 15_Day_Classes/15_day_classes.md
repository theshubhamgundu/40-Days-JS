<div align="center">
  <h1> 40 Days Of JavaScript: Classes</h1>
...
const person1 = new Person('shubham', 'Gundu')
...
const person1 = new Person('shubham', 'Gundu')
const person2 = new Person('Ananya', 'Tekle')
const person3 = new Person('Vikram', 'Gundu')
...
const person1 = new Person('shubham', 'Gundu', 250, 'Karnataka', 'Bangalore')
...
const person2 = new Person('Ananya', 'Tekle', 28, 'Karnataka', 'Espoo')
...
const s1 = new Student('shubham', 'Gundu', 'Karnataka', 250, 'Bangalore')
console.log(s1)
...
const s2 = new Student('Ananya', 'Tekle', 28, 'Karnataka', 'Bangalore', 'Female')
s1.setScore = 1
s1.setSkill = 'HTML'
s1.setSkill = 'CSS'
...
console.log('Mean: ', statistics.mean()) // 40
