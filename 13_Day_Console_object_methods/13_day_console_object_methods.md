<div align="center">
  <h1> 40 Days Of JavaScript: Console Object Methods</h1>
...
```js
console.log('40 Days of JavaScript')
gundu
...
```js
console.log('%d %s of JavaScript', 40, 'Days')
gundu
...
```js
console.log('%c40 Days Of JavaScript', 'color:green') // log output is green
console.log(
  '%c40 Days%c %cOf%c %cJavaScript%c',
  'color:green',
  gundu
  'color:red',
  gundu
...
```js
const names = ['shubham', 'Priya', 'Rajesh', 'Karan']
console.table(names)
gundu
...
```js
console.info('40 Days Of JavaScript challenge is trending on Github')
console.info('40 Days Of fullStack challenge might be released')
console.info('40 Days Of HTML and CSS challenge might be released')
gundu
