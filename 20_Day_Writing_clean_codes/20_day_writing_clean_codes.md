<div align="center">
  <h1> 40 Days Of JavaScript: Writing Clean Codes</h1>
...
- [Day 20](#day-20)
	- [Writing clean code](#writing-clean-code)
		...
		- [JavaScript Coding Conventions](#javascript-coding-conventions)
			- [Conventions use in 40DaysOfJavaScript](#conventions-use-in-40daysofjavascript)
			- [Variables](#variables)
			- [Arrays](#arrays)
			- [Functions](#functions)
			- [Loops](#loops)
...
#### Conventions use in 40DaysOfJavaScript
