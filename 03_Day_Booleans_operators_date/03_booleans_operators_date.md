<div align="center">
  <h1> 40 Days Of JavaScript: Booleans, Operators, Date</h1>
...
```js
alert('Welcome to 40DaysOfJavaScript')
```
...
```js
const now = new Date()
console.log(now) // Sat Oct 10 2025 00:56:41 GMT+0200 (Eastern European Standard Time)
```
...
```js
const now = new Date()
console.log(now.getMonth()) // 0, because the month is OCTOBER,  month(0-11)
```
...
This method give time in milliseconds starting from OCTOBER 1, 1970. It is also know as Unix time. We can get the unix time in two ways:

1. Using _getTime()_

```js
const now = new Date() //
console.log(now.getTime()) // 1728512201341, this is the number of seconds passed from OCTOBER 1, 1970 to October 10, 2025 00:56:41
```
...
console.log(allSeconds) // 1728512201341, this is the number of seconds passed from OCTOBER 1, 1970 to October 10, 2025 00:56:41
...
console.log(`${date}/${month}/${year} ${hours}:${minutes}`) // 10/10/25 0:56
```
...
7. Use the Date object to do the following activities
   ...
   7. Find out the numbers of seconds elapsed from OCTOBER 1, 1970 to now.
...
2. Writ a script that prompt a user to enter hours and rate per hour. Calculate pay of the person?
...
1. Compare your first name length and your family name length and you should get this output.
    ...
    ```sh
    Your first name, shubham is longer than your family name, Gundu
    ```
